...
CC = ['/usr/bin/gcc']
CCDEFINES = []
CCFLAGS = ['-O3', '-g', '-Wall', '-Werror', '-Wall', '-g', '-O0', '-march=native', '-fstrict-overflow', '-Wstrict-overflow=2', '-std=c++11', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXFLAGS = ['-Wall', '-g', '-O0', '-march=native', '-fstrict-overflow', '-Wstrict-overflow=2', '-std=c++11']
...
DEFINES_ST = '-D%s'
DEFINE_COMMENTS = {'HAVE_SYS_TYPES_H': '', 'HAVE_GSL': '', 'HAVE_NET_ETHERNET_H': '', 'HAVE_IF_NETS_H': '', 'HAVE_UINT128_T': '', 'HAVE_SYS_STAT_H': '', 'HAVE___UINT128_T': '', 'HAVE_LIBXML2': '', 'HAVE_RT': '', 'HAVE_SQLITE3': '', 'HAVE_DIRENT_H': '', 'HAVE_STDLIB_H': '', 'HAVE_SYS_INT_TYPES_H': '', 'HAVE_INTTYPES_H': '', 'HAVE_IF_TUN_H': '', 'HAVE_PACKET_H': '', 'HAVE_STDINT_H': '', 'HAVE_SIGNAL_H': '', 'INT64X64_USE_128': '', 'HAVE_PTHREAD_H': '', 'HAVE_GETENV': '', 'HAVE_SYS_IOCTL_H': ''}
DEST_BINFMT = 'elf'
DEST_CPU = 'x86_64'
DEST_OS = 'linux'
...
EXAMPLE_DIRECTORIES = ['udp', 'tcp', 'tutorial', 'routing', 'ipv6', 'traffic-control', 'realtime', 'stats', 'wireless', 'error-model', 'socket', 'energy', 'naming', 'matrix-topology', 'udp-client-server']
...
NS3_EXECUTABLE_PATH = ['/home/gppcom/2020_1/ns-3-lora-gppcom/ns-new-implementation/ns-3.29/build/src/fd-net-device', '/home/gppcom/2020_1/ns-3-lora-gppcom/ns-new-implementation/ns-3.29/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/4.9', '/home/gppcom/2020_1/ns-3-lora-gppcom/ns-new-implementation/ns-3.29/build/lib']
...
cfg_files = ['/home/gppcom/2020_1/ns-3-lora-gppcom/ns-new-implementation/ns-3.29/build/ns3/config-store-config.h', '/home/gppcom/2020_1/ns-3-lora-gppcom/ns-new-implementation/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
